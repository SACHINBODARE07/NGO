...
export default function About() {
  ...
  const documents: DocumentType[] = [
    { 
      ...
      link: "/images/documents/Register letter.JPG",
      icon: <Scale size={24} />
    },
    { 
      id: 2, 
      ...
      link: "/images/documents/pancard.JPG",
      icon: <Shield size={24} />
    },
    { 
      id: 3, 
      ...
      link: "/images/documents/letter.JPG",
    ...
    { 
      ...
      link: "/images/documents/Form-10.JPG",
      icon: <Award size={24} />
    },
  ];

  return (
    <div className="pt-20 md:pt-24 pb-16 md:pb-20 selection:bg-rose-100 bg-white">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center mb-20 md:mb-24">
          <div className="space-y-4 md:space-y-6">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-7xl font-black text-teal-950 tracking-tight leading-[1.1]">
              A Voice for <br />
              <span className="text-rose-600 italic">the Unheard.</span>
            </h1>
            <p className="text-base md:text-lg text-zinc-600 leading-relaxed font-medium max-w-xl">
              Founded in 2017 in Guna, Madhya Pradesh, Pukar Mahila Mandal started as a small gathering of 10 women. Today, we are a powerhouse federation of <span className="text-teal-950 font-bold">2,500+ leaders</span>.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-5 md:gap-6">
            <div className="group bg-zinc-50 p-6 md:p-8 rounded-2xl md:rounded-3xl border border-zinc-100 transition-all hover:bg-white hover:shadow-lg hover:shadow-zinc-200/50">
              ...
              <h3 className="text-base font-black text-teal-950 uppercase tracking-wider mb-2">Our Mission</h3>
            ...
            <div className="group bg-zinc-50 p-6 md:p-8 rounded-2xl md:rounded-3xl border border-zinc-100 transition-all hover:bg-white hover:shadow-lg hover:shadow-zinc-200/50">
              ...
              <h3 className="text-base font-black text-teal-950 uppercase tracking-wider mb-2">Our Vision</h3>
              <p className="text-zinc-500 font-medium text-sm leading-relaxed">
        ...
        <section className="mt-20 md:mt-24">
          <div className="flex flex-col md:flex-row justify-between items-end mb-10 md:mb-14 gap-6">
            <div className="space-y-2 text-center md:text-left w-full md:w-auto">
              ...
              <h3 className="text-3xl md:text-5xl font-black text-teal-950 tracking-tighter">Verify Our Status</h3>
            </div>
            <div className="flex items-center gap-2 px-4 py-2 bg-zinc-50 rounded-xl border border-zinc-100 shadow-sm w-full md:w-auto">
              <Lock size={14} className="text-rose-600" />
              <span className="text-zinc-500 font-bold text-[10px] uppercase tracking-widest">End-to-End Encrypted Preview</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
            {documents.map((doc) => (
              <button
                ...
                className="group relative bg-white border border-zinc-200 p-6 md:p-8 rounded-2xl md:rounded-3xl transition-all duration-500 hover:border-rose-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-rose-100/30 overflow-hidden"
              >
                <div className="absolute -right-6 -bottom-6 w-24 h-24 bg-rose-50 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity" />
                ...
                <div className="relative z-10">
                  ...
                  <h4 className="text-xl md:text-2xl font-black text-teal-950 mb-1 tracking-tight transition-colors group-hover:text-rose-600">
                    {doc.title}
                  </h4>
                  <p className="text-zinc-400 text-[10px] font-bold uppercase tracking-wider mb-6">
                    {doc.subtitle}
                  </p>

                  <div className="inline-flex items-center gap-2 text-rose-600 font-black text-[10px] uppercase tracking-[0.2em] pt-3 border-t border-zinc-100 w-full transition-all group-hover:border-rose-100">
      ...
      {activeDoc && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 md:p-6 overflow-hidden">
          ...
          <div className="relative bg-white w-full max-w-4xl max-h-[90vh] rounded-xl md:rounded-2xl overflow-auto flex flex-col shadow-2xl animate-in zoom-in slide-in-from-bottom-10 duration-500">
            
            {/* Modal Header */}
            <div className="sticky top-0 bg-white z-20 px-5 py-4 flex items-center justify-between border-b border-zinc-100">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-rose-600 text-white rounded-xl flex items-center justify-center shadow-md">
                  <Shield size={20} />
                </div>
                <div>
                  <h3 className="text-base font-black text-teal-950 uppercase tracking-tight">{activeDoc.title}</h3>
                  <div className="flex items-center gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse" />
                    <p className="text-[8px] font-black text-zinc-400 uppercase tracking-[0.2em]">Live Secure Preview</p>
                  </div>
                </div>
              </div>
              <button 
                onClick={() => setActiveDoc(null)}
                className="p-2 bg-zinc-50 rounded-xl hover:bg-rose-600 transition-all"
              >

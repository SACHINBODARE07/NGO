...
export default function Donors() {
  return (
    <div className="pt-24 pb-20 md:pt-32 md:pb-24 bg-white overflow-x-hidden">
      <div className="max-w-7xl mx-auto px-6">
        {/* Hero Section */}
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center mb-20 md:mb-24">
          <div className="space-y-6 md:space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-rose-50 text-rose-600 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mx-auto lg:mx-0">
              <Heart size={14} fill="currentColor" /> Wall of Kindness
            </div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-teal-950 tracking-tighter leading-tight">
          ...
          <div className="bg-zinc-50 rounded-2xl md:rounded-3xl p-8 md:p-12 border border-zinc-100 flex items-center justify-center relative overflow-hidden shadow-md">
            <div className="text-center relative z-10">
              <div className="text-5xl md:text-6xl font-black text-teal-950 mb-2">500+</div>
        ...
        <div className="mb-20 md:mb-24">
          <h3 className="text-xl md:text-2xl font-black text-teal-950 mb-6 md:mb-8 flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
            Our Institutional Partners
            <div className="h-px flex-1 bg-zinc-100 w-full sm:w-auto" />
          </h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
            {corporateDonors.map((donor, i) => (
              <div
                key={i}
                className="group p-6 md:p-8 bg-white border border-zinc-100 rounded-2xl md:rounded-3xl hover:shadow-xl hover:shadow-zinc-100 transition-all text-center hover:-translate-y-1"
              >
                <div className="w-12 h-12 md:w-14 md:h-14 bg-zinc-50 rounded-xl md:rounded-2xl mx-auto mb-4 md:mb-6 flex items-center justify-center text-zinc-400 group-hover:text-rose-600 group-hover:bg-rose-50 transition-all">
                  <Star size={22} className="md:w-6 md:h-6" />
                </div>
                <h4 className="text-lg md:text-xl font-black text-teal-950 mb-1">
                  {donor.name}
                </h4>
